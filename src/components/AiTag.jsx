    ...
    <div className="w-full max-w-8xl bg-black rounded-lg shadow-xl overflow-hidden border-2 border-orange-600">
      <div className="p-6 sm:p-8 md:p-10 flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="flex items-center space-x-4 flex-shrink-0">
          {/* Custom AI Brain Icon - combining Settings and Brain for a similar look */}
          <div className="relative text-orange-500">
            <Settings size={48} strokeWidth={1.5} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
            <Brain size={24} strokeWidth={2} className="relative z-10" />
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold text-orange-500 leading-tight">
            AI-ENABLED LEARNING
          </h2>
        </div>
        ...
        <div className="flex-shrink-0">
          <BookOpen size={48} strokeWidth={1.5} className="text-orange-500" />
        </div>
      </div>
    </div>
  );
